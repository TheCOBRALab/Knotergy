...
TEST(PK_energies, HType_Turner) {
    ...
    EXPECT_NEAR(turner_result, -33.3810, 0.00005);
    EXPECT_NEAR(turner_rounded, -33.42, 0.00005);
}
...
TEST(PK_energies, LLType_DP) {
    ...
    EXPECT_NEAR(dp_result, -25.8912, 0.00005);
    EXPECT_NEAR(dp_rounded, -25.86, 0.00005);
}
...
TEST(PK_energies, LLType_Turner) {
    ...
    EXPECT_NEAR(turner_result, -42.021, 0.00005);
    EXPECT_NEAR(turner_rounded, -42.06, 0.00005);
}
...
TEST(PK_energies, LLType_Long_DP) {
    ...
    EXPECT_NEAR(dp_result, -8.9765, 0.00005);
    EXPECT_NEAR(dp_rounded, -8.98, 0.00005);
}
...
TEST(PK_energies, LLType_Long_Turner) {
    ...
    EXPECT_NEAR(turner_result, -15.08, 0.00005);
    EXPECT_NEAR(turner_rounded, -15.11, 0.00005);
}
...
TEST(PK_energies, HLinType_DP) {
    ...
    EXPECT_NEAR(dp_result, -0.7629, 0.00005);
    EXPECT_NEAR(dp_rounded, -0.74, 0.00005);
}
...
TEST(PK_energies, HLinType_Turner) {
    ...
    EXPECT_NEAR(turner_result, -5.831, 0.00005);
    EXPECT_NEAR(turner_rounded, -5.84, 0.00005);
}
...
TEST(PK_energies, multi_nested_DP) {
    ...
    EXPECT_NEAR(dp_result, 0.047, 0.00005);
    EXPECT_NEAR(dp_rounded, 0.07, 0.00005);
}
...
TEST(PK_energies, multi_nested_Turner) {
    ...
    EXPECT_NEAR(turner_result, -5.748, 0.00005);
    EXPECT_NEAR(turner_rounded, -5.77, 0.00005);
}
...
TEST(PK_energies, two_multiloops_DP) {
    ...
    EXPECT_NEAR(dp_result, 4.6223, 0.00005);
    EXPECT_NEAR(dp_rounded, 4.65, 0.00005);
}
...
TEST(PK_energies, two_multiloops_Turner) {
    ...
    EXPECT_NEAR(turner_result, -0.189, 0.00005);
    EXPECT_NEAR(turner_rounded, -0.2, 0.00005);
}
...
TEST(PK_energies, kissing_muliloop_DP) {
    ...
    EXPECT_NEAR(dp_result, -1.9068, 0.00005);
    EXPECT_NEAR(dp_rounded, -1.8600, 0.00005);
}
...
TEST(PK_energies, kissing_muliloop_Turner) {
    ...
    EXPECT_NEAR(turner_result, -11.422, 0.00005);
    EXPECT_NEAR(turner_rounded, -11.44, 0.00005);
}
...
TEST(PK_energies, nestedPK_in_band_DP) {
    ...
    EXPECT_NEAR(dp_result, -60.0667, 0.00005);
    EXPECT_NEAR(dp_rounded, -59.93, 0.00005);
}
...
TEST(PK_energies, nestedPK_in_band_Turner) {
    ...
    EXPECT_NEAR(turner_result, -99.4670, 0.00005);
    EXPECT_NEAR(turner_rounded, -99.54, 0.00005);
}
