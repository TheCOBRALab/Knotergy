...
namespace knotergy {
    ...
    struct pk_param {
        ...
        pk_param(const std::string& param_name, int pk_ext, int pk_multi, int pk_pk,
                         int band_pen, int unpaired_pk, int cr_in_pk_pen,
                         double pk_stack_multiplier, double pk_internal_multiplier,
                         int pk_mloop_init_pen, int pk_mloop_bp_pen, int pk_mloop_unpaired_pen)
            : name(param_name),
              pk_in_ext(pk_ext),
    ...
    class PseudoknotParams {
        ...
        static const pk_param load_pk_param(const std::string& paramFile = "./params/common/pk_DirksPierce09_HotKnotsV2.json") {
