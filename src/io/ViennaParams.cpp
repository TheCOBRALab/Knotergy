...
void ViennaParams::load_energy_parameters(const std::string& paramFile, int dangle, const std::string& seq) {
...
std::vector<modified_base_params> ViennaParams::load_modified_energy_parameters(const std::string& path) {
    if (path.empty()) {
        return {};
    }
