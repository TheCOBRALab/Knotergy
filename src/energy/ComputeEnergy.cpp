...
float ComputeEnergy::process_node(const LoopNode& node) {
    ...
    switch (type) {
        case LoopType::Stack:
            ...
            std::cout << "Stack (" << node.begin << ", " << node.end << "): " << node_energy << std::endl;
            break;
        case LoopType::Hairpin:
            node_energy += vienna.hairpin_energy(node.begin, node.end, sequence_);
            std::cout << "Hairpin (" << node.begin << ", " << node.end << "): " << node_energy << std::endl;
            break;
        case LoopType::Internal:
            ...
            std::cout << "Internal (" << node.begin << ", " << node.end << "): " << node_energy << std::endl;
            break;
        case LoopType::Multibranch:
            node_energy += vienna.multibranch_energy(node, sequence_);
            std::cout << "Multibranch (" << node.begin << ", " << node.end << "): "  << node_energy << std::endl;
            break;
        ...
        case LoopType::External:
            ...
            std::cout << "External (" << node.begin << ", " << node.end << "): " << node_energy << std::endl;
            break;
    }
