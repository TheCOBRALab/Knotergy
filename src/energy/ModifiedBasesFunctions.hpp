...
class ModifiedBasesFunctions {
   public:
     ...
     */
    [[nodiscard]] static int find_mod_stack_energy(size_t i, size_t j, size_t ci, size_t cj,
     ...
     * @return Energy difference in centicalories to apply to the loop's energy due to modified
     * bases.
     *
     */
   ...
   private:
    ...
    /**
     * @brief Get the energy difference between modified and unmodified for a given key and lookup
     * type.
     *
     * @param key The parameter key to look up.
     ...
     */
    [[nodiscard]] static int get_mod_energy_difference(
